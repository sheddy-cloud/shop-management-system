							...
							<td class="text-center">
								...
								<div class="dropdown">
									...
									<ul class="dropdown-menu" role="menu">
										<li><a class="dropdown-item view_data" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>"><span class="fa fa-eye text-dark"></span> View</a></li>
										<li><hr class="dropdown-divider"></li>
										<li><a class="dropdown-item edit_data" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>"><span class="fa fa-edit text-primary"></span> Edit</a></li>
										<li><hr class="dropdown-divider"></li>

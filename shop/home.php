...
<div class="row mb-4">
    ...
    <div class="card h-100">
      <div class="card-body text-center">
        <div class="d-flex flex-column flex-sm-row align-items-center justify-content-center mb-3">
          <div class="bg-primary bg-gradient rounded-circle p-2 p-sm-3 me-0 me-sm-3 mb-2 mb-sm-0">
            <i class="fas fa-shopping-cart text-white fs-5 fs-sm-4"></i>
          </div>
          <div class="text-center text-sm-start">
            <h3 class="fw-bold text-primary mb-0 fs-4 fs-sm-3">
              <?php 
  ...
  <div class="col-lg-3 col-md-6 col-sm-6 mb-3">
    <div class="card h-100">
      <div class="card-body text-center">
        <div class="d-flex flex-column flex-sm-row align-items-center justify-content-center mb-3">
          <div class="bg-success bg-gradient rounded-circle p-2 p-sm-3 me-0 me-sm-3 mb-2 mb-sm-0">
            <i class="fas fa-cash-register text-white fs-5 fs-sm-4"></i>
          </div>
          <div class="text-center text-sm-start">
            <h3 class="fw-bold text-success mb-0 fs-4 fs-sm-3">
              <?php 
          ...
          <table class="table table-hover">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a href="?page=sales/view_sale&id=<?php echo $row['id'] ?>" class="btn btn-sm btn-info" title="View Details" target="_blank">
          ...
          <table class="table table-hover">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a href="?page=maintenance/view_item&id=<?php echo $row['id'] ?>" class="btn btn-sm btn-info" title="View Item" target="_blank">
                    <i class="fas fa-eye"></i>
                  </a>
                  <a href="?page=maintenance/manage_item&id=<?php echo $row['id'] ?>" class="btn btn-sm btn-warning" title="Edit Item" target="_blank">

...
<div class="card card-outline card-primary">
    ...
    <div class="card-footer py-1 text-center">
        ...
        <a class="btn btn-flat btn-dark" href="<?php echo base_url.'/shop?page=purchase_order' ?>">Cancel</a>
    </div>
</div>
<script>
    $(function(){
			...
			$.ajax({
				...
				success:function(resp){
					if(resp.status == 'success'){
						location.replace(_base_url_+"shop/?page=receiving/view_receiving&id="+resp.id);
